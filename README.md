...
## Installing gitflow-hooks

See the Wiki for up-to-date [Installation Instructions](https://github.com/smarzougui/gitflow-hooks/wiki/Installation).
...
list](http://github.com/smarzougui/gitflow-hooks/issues) on Github to provide that
feedback.
